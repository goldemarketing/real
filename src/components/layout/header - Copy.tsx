...
import Image from "next/image"; // <--- 1. أضفنا هذا السطر
...
// import { Logo } from "@/components/icons"; // <--- لم نعد بحاجة لهذا، قمت بإلغاء تفعيله
          ...
          <div className={cn(
            ...
            <div className="flex-1 justify-start">
              <Link href="/" className="flex items-center">
                {/* 2. هنا تم التعديل لإضافة صورة اللوجو بدلاً من النص والرمز القديم */}
                <Image 
                  src="/logo1.png"     // تأكد من وجود الصورة في public بهذا الاسم
                  alt="4 Seasons"
                  width={93}         // عرض اللوجو، عدله حسب الحاجة
                  height={15}         // ارتفاع اللوجو
                  className="object-contain mt-2"
                  priority            // لتحميل اللوجو فوراً
                />
              </Link>
            </div>
                ...
                <SheetHeader className="p-4 border-b text-left flex flex-row justify-between items-center">
                  <SheetTitle>
                      <Link href="/" className="flex items-center" onClick={() => setOpen(false)}>
                        {/* 3. تعديل اللوجو في الموبايل أيضاً */}
                        <Image 
                          src="/logo.png" 
                          alt="4 Seasons"
                          width={120} 
